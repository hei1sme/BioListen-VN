...
**Speaker:**
"Về mặt hiệu năng, giải pháp của chúng tôi đạt độ chính xác phân loại tổng thể trên **88%** dựa trên tập dữ liệu thử nghiệm. `[Pause]` Tốc độ chạy mô hình thực tế (Inference Latency) cực kỳ nhanh, dưới **124 ms** cho mỗi khung âm thanh 5 giây, hoàn hảo để nhúng trực tiếp vào các phần cứng Edge."
...
Với BioListen VN, chúng tôi tối ưu mô hình PyTorch, xuất ra chuẩn **ONNX Runtime** để chạy trực tiếp trên vi điều khiển giá rẻ ESP32-S3 với tổng chi phí linh kiện **dưới 20 đô la**. Đồng thời, thay vì stream file âm thanh nặng nề làm cạn kiệt băng thông, thiết bị Edge chỉ gửi gói JSON **dưới 42 Bytes** qua sóng LoRaWAN. Đây chính là công thức giúp hệ thống tồn tại bền bỉ ngoài thực địa bằng pin mặt trời nhỏ.

*BOM (Bill of Materials) chi tiết thiết bị biên $20:*
- *Vi xử lý:* ESP32-S3 (Dual-core LX7, 8MB PSRAM, tích hợp tập lệnh tăng tốc AI vector) ~ $4.50
- *Cảm biến âm thanh:* Microphone kỹ thuật số I2S MEMS (INMP441) chống ẩm ~ $1.50
- *Truyền thông:* Module thu phát sóng vô tuyến LoRa RFM95W (915MHz) ~ $4.00
- *Năng lượng:* Tấm pin mặt trời 5V-2W + Mạch sạc TP4056 tự động ngắt ~ $3.50
- *Lưu trữ điện:* Pin Lithium-ion 18650 dung lượng 2600mAh hoạt động ban đêm ~ $2.50
- *Vỏ hộp & Ăng-ten:* Vỏ in 3D chống nước IP67 + Ăng-ten LoRa ~ $3.00
- *Tổng giá thành:* ~ $19.00 USD (Dưới $20 USD)"
...
- **Tháng thứ 3:** Phối hợp cùng BQL Cúc Phương triển khai thí điểm trạm POC thực tế để thu thập dữ liệu thật, từ đó fine-tune lại mô hình PyTorch.
