...
**Speaker:**
"Về mặt hiệu năng, giải pháp của chúng tôi đạt độ chính xác phân loại tổng thể trên **[X]%** dựa trên tập dữ liệu thử nghiệm. `[Pause]` Tốc độ chạy mô hình thực tế (Inference Latency) cực kỳ nhanh, dưới **[Y] ms** cho mỗi khung âm thanh 5 giây, hoàn hảo để nhúng trực tiếp vào các phần cứng Edge."
...
Với BioListen VN, chúng tôi tối ưu mô hình PyTorch, xuất ra chuẩn **ONNX Runtime** để chạy trực tiếp trên vi điều khiển giá rẻ ESP32-S3 với tổng chi phí linh kiện **dưới [Cost] đô la**. Đồng thời, thay vì stream file âm thanh nặng nề làm cạn kiệt băng thông, thiết bị Edge chỉ gửi gói JSON **dưới [Z] Bytes** qua sóng LoRaWAN. Đây chính là công thức giúp hệ thống tồn tại bền bỉ ngoài thực địa bằng pin mặt trời nhỏ."
...
- **Tháng thứ 6:** Gọi vốn Seed vòng 1 để sản xuất hàng loạt [N] trạm, hướng tới phủ sóng toàn bộ phân khu rừng đặc dụng."
