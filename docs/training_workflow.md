...
* **Bảng Ánh xạ Taxonomy & Tên hiển thị Dashboard (s0 -> s23):**
  Dữ liệu thực địa RFCx được thu thập tại khu bảo tồn Puerto Rico. Dưới đây là bảng đối chiếu tên khoa học, tên tiếng Anh và tên tiếng Việt đề xuất cho 24 loài:
